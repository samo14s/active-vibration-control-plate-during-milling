...
|:---:|:---:|:---:|
| اسمي (1.0×) | ✅ **2.35µm / 9.6V** | ✅ 5.11µm / 21.7V |
| 1.6× | ✅ 3.75µm | ✅ |
| **1.8×** | ❌ يتباعد (t≈20.3s) | ✅ **5.75µm / 23V** |
| **2.0×** | ❌ | ✅ **6.43µm / 39V** |
| 2.2× / 2.5× | ❌ | ❌ (t≈20.0/19.5s) |

¹ القيم هنا RMS **كلّي** للمرور (اصطلاح شكل السقف)؛ جدول المرور الاسمي أعلاه يستعمل
متوسّط RMS **النافذي** (اصطلاح `full_pass.py`) فيبدو أعلى قليلاً (3.71 مقابل 2.35).
