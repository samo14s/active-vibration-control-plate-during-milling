...
| **H‑infinity** | **2.35** | **7.59** | 4.5 | 49.6 | 6.1 | 0.98 |
...
النِّسب <1 لأن اضطراب الكتلة يُخفّف قليلاً أرضية الاهتزاز القسري.
...
- **H‑infinity**: أفضل أداء اسمي (أقلّ إزاحة 2.35µm وذروة 7.6µm).
- **µ‑synthesis**: قريب جداً من H∞ (2.89µm) بأقلّ طاقة تحكّم، ويُدرِج **وزن عدم
  اليقين الجمعي للورقة `W_Pau`** صراحةً في حلقة D‑K التي تُخفّض القيمة المفردة
  المُهيكَلة µ.
- **SMC**: أقلّ جهد ذروة (11.6V)، ومتانة عالية بفضل الحدّ التبديلي، مقابل إزاحة
  متبقية أعلى.
- **ADRC**: أداء جيد (3.78µm) لكن حساسية طفيفة لانزياح التردّد الصاعد الكبير.
- **PID / MPC**: بسيطان وفعّالان ومتينان تردّدياً، بإزاحة متبقية أعلى.
...
| `fig_full_pass.png` | **المرور الكامل (20.4 ث):** الديناميكا المتغيّرة + قمع الثرثرة عبر كامل المسار (من `full_pass.py`) |
