...
| **المشغّل** (بيزو، اقتران انحناء) | الزاوية السفلية اليمنى `(0.8, 0.25)` | `Φ_act=[6.6, 3.96, −8.49]` |
...
عندهما ⟹ المنشأة **minimum‑phase قابلة للتحكّم**. أشكال الأنماط مبنية من نظرية اللوح
المنحصر (`plate_mode_shape` في `config.py`).
