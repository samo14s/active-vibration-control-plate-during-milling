...
kirchhoff_q4.py
================
[LEGACY — N'EST PLUS UTILISÉ PAR LE MODÈLE]
...
⚠️  Depuis le passage à la MODÉLISATION ANALYTIQUE de Nasiri & Moradi
    (MSSP 2025), la plaque est décrite par sommation modale de Galerkin
    (Von Kármán) dans ``plate_model.py``, qui ne dépend PLUS de ce module FEM.
    Ce fichier est conservé uniquement comme référence de l'ancienne
    discrétisation Kirchhoff-Q4 (les fréquences propres FEM d'origine
    [521.06, 1069.95, 2733.02] Hz servent de calibration des valeurs
    principales dans le nouveau modèle analytique).
"""
import numpy as np
