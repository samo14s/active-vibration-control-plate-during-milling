...
> الخطية 3.2× عند أسوأ موضع تبقى أكبر من الواحد عند التفاوتات الضيقة
> وتنقلب إلى 0.79× عند 20 µm (الأرقام الدقيقة في سجل §5 من النص
> التأسيسي) — وهو، على حدّ علمنا، أول برهان كمّي (محاكاةً، على منصة
> مرسَّخة قياسيًا) على أن هوامش الاستقرار الخطية قد تُسيء ترتيب
