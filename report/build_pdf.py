...
FIGS_OBS = [
    ('## 7. خلاصة مرحليّة — المُلاحِظ بنطاقات ثابتة', 'fig_fdob_B.png',
    ...
    ('## 7. خلاصة مرحليّة — المُلاحِظ بنطاقات ثابتة', 'fig_summary_B.png',
     'جدول الأرقام الكامل للبنى الأربع.'),
    ('## 8. المُشرِف على `α` مع مُقدِّر تردّد الخَرخَرة', 'fig_supervisor_B.png',
     'المُشرِف مأخوذًا بالجرم: (a) بنطاقات ثابتة يتباعد الممرّ وبالإشراف ينجو، '
     '(b) المُقدِّر الأوّل يقفل على المود المنحرف والثاني يمتنع لأنّ موده لا '
     'يخرخر، (c) `α` لا يشتبك إلّا عند وجود ما يُشتبَك ضدّه، (d) المكسب في وسط '
     'الممرّ ومقياس أسوأ موضع يُخفيه.'),
    ('## 9. ربط `α` بجودة القفل — قياس، ونتيجة سالبة', 'fig_positions_B.png',
